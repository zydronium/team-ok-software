...
insert into Workspaces(Claimed, ClaimedUntill, Created, Deleted, FloorID, MacAddress, Modified, Name) values (1, GETDATE(), GETDATE(), 0, 1, 'workspace1', GETDATE(), 'Werkplek 1');
...
insert into Workspaces(Claimed, ClaimedUntill, Created, Deleted, FloorID, MacAddress, Modified, Name) values (0, GETDATE(), GETDATE(), 0, 1, 'workspace2', GETDATE(), 'Werkplek 2');
